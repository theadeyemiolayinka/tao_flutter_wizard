...
lib/
  ...
  l10n/
    ...
    generated/         ← Output of flutter gen-l10n (committed to VCS)
  scripts/
...
| `l10n.yaml` | `flutter gen-l10n` config — outputs to `lib/l10n/generated/`, `synthetic-package: false` |
...
live in `lib/l10n/app_en.arb`, which is the single file `flutter gen-l10n` reads.
...
lib/features/<feature>/l10n/<feature>_en.arb   ← you write strings here
 ...
 lib/l10n/app_en.arb                           ← merged base file
         ...
         │  flutter gen-l10n
         ▼
 lib/l10n/generated/app_localizations.dart      ← generated Dart code
```
